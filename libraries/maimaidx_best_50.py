...
class DrawBest(Draw):
    ...
    async def draw(self) -> Image.Image:
        ...
        self._mr.draw(900, 2465, 35, f'Designed by Ricaran & Yuri-YuzuChaN & BlueDeer233 | Generated by {maiconfig.botName}', (0, 50, 100, 255), 'mm', 3, (255, 255, 255, 255))
...
async def generate_other50(userdata,qqid: Optional[int] = None, username: Optional[str] = None) -> str:
    try:
        if username:
            qqid = None

        mai_info = UserInfo(**userdata)
